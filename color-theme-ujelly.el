...
(defvar ujelly-red-1 "#dd0093")
(defvar ujelly-red-2 "#de5577")
  ...
  (color-theme-install
   (append
    (list 'color-theme-ujelly
          ...
          `(diredp-file-name ((t (:foreground ,ujelly-red-0))))
          `(diredp-file-suffix ((t (:foreground ,ujelly-red-0))))
          `(diredp-link-priv ((t (:foreground ,ujelly-green-2))))
          `(diredp-number ((t (:foreground ,ujelly-fg))))
          `(diredp-no-priv ((t (:foreground ,ujelly-fg))))
          `(diredp-read-priv ((t (:foreground ,ujelly-green-2))))
          `(diredp-symlink ((t (:foreground ,ujelly-red-1))))
          ...
          `(eshell-ls-directory ((t (:foreground ,ujelly-green-2))))
